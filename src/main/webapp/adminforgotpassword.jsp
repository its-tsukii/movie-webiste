			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">Forgot Password For Administrators ?</h2>
					
						<form action="AdminForgotPassServlet" method="post">
							<table>
					...
					<div class="signup-image">
						<figure>
							<img src="images/adminforgotpass.png" alt="sing up image">
						</figure>
